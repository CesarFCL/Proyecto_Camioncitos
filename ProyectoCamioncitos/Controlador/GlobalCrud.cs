...
namespace ProyectoCamioncitos.Controlador
{
     ...
     * para no repetir los mismos metodos en cada controlador CRUD se hace una clase que los abarque (que seria esta)
     * y ya luego los controladores CRUD heredan estos metodos y asi no se debe repetir estos metodos en cada
     * controlador CRUD. La dvd nse, en mi cabeza suena bien y todo pero capaz y se debe hacer de otra forma xd
     */
